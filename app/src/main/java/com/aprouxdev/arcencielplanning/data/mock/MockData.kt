...
class MockData {
    companion object {
        ...
        val event1 = Event(id = "1", date= null, time="08:00", team = Teams.Toys, users= emptyList(), title = "Tri des jouets", description = "Lorem Ipsum", comments = listOf(
            comment1, comment2))
        val event2 = Event(id = "2", date= null, time="10:00", team = Teams.Toys, users= emptyList(), title = "Tri des jouets", description = "Lorem Ipsum", comments = listOf(
            comment1, comment2, comment3, comment4))
        val event3 = Event(id = "3", date= null, time="08:00", team = Teams.Other, users= emptyList(), title = "Nettoyage d'été", description = "Lorem Ipsum", comments = emptyList())
        val event4 = Event(id = "4", date= null, time="08:00", team = Teams.Clothes, users= emptyList(), title = "Tri vêtement", description = "Lorem Ipsum", comments = listOf(
            comment1, comment2))
        val event5 = Event(id = "5", date= null, time="10:00", team = Teams.Cleaning, users= emptyList(), title = "Ménage", description = "Lorem Ipsum", comments = emptyList())
        val event6 = Event(id = "6", date= null, time="14:00", team = Teams.Shop, users= emptyList(), title = "Magasin samedi matin", description = "Lorem Ipsum", comments = listOf(
            comment5, comment6))
        val event7 = Event(id = "7", date= null, time="12:30", team = Teams.Braderie, users= emptyList(), title = "Préparation braderie", description = "Lorem Ipsum", comments = emptyList())
        val event8 = Event(id = "8", date= null, time="08:00", team = Teams.Toys, users= emptyList(), title = "Point jouets", description = "Lorem Ipsum", comments = emptyList())
